...
// jsData 
function gvisDataSankeyID1ce570794ff () {
...
// jsDrawChart
function drawChartSankeyID1ce570794ff() {
var data = gvisDataSankeyID1ce570794ff();
var options = {};
options["width"] = 400;
options["height"] = 400;
options["sankey"] = {
    ...
    document.getElementById('SankeyID1ce570794ff')
    );
...
callbacks.push(drawChartSankeyID1ce570794ff);
})();
function displayChartSankeyID1ce570794ff() {
  var pkgs = window.__gvisPackages = window.__gvisPackages || [];
  var callbacks = window.__gvisCallbacks = window.__gvisCallbacks || [];
...
<!-- jsChart -->  
<script type="text/javascript" src="https://www.google.com/jsapi?callback=displayChartSankeyID1ce570794ff"></script>
 
<!-- divChart -->
  
<div id="SankeyID1ce570794ff" 
