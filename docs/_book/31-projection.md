...
// jsData 
function gvisDataSankeyID1ce5672fe8ed () {
...
// jsDrawChart
function drawChartSankeyID1ce5672fe8ed() {
var data = gvisDataSankeyID1ce5672fe8ed();
var options = {};
options["width"] = 400;
options["height"] = 400;
options["sankey"] = {
    ...
    document.getElementById('SankeyID1ce5672fe8ed')
    );
...
callbacks.push(drawChartSankeyID1ce5672fe8ed);
})();
function displayChartSankeyID1ce5672fe8ed() {
  var pkgs = window.__gvisPackages = window.__gvisPackages || [];
  var callbacks = window.__gvisCallbacks = window.__gvisCallbacks || [];
...
<!-- jsChart -->  
<script type="text/javascript" src="https://www.google.com/jsapi?callback=displayChartSankeyID1ce5672fe8ed"></script>
 
<!-- divChart -->
  
<div id="SankeyID1ce5672fe8ed" 
...
## [58] lattice_0.20-34        locfit_1.5-9.1         pillar_1.2.1          
## [61] igraph_1.1.2           rjson_0.2.15           reshape2_1.4.3        
## [64] codetools_0.2-15       biomaRt_2.34.2         XML_3.98-1.10         
## [67] glue_1.2.0             evaluate_0.10.1        data.table_1.10.4-3   
## [70] httpuv_1.3.6.1         gtable_0.2.0           assertthat_0.2.0      
