...
```{r, eval=FALSE}
devtools::install_github("tallulandrews/M3D", ref="nbumi") # different branch
devtools::install_github("tallulandrews/M3Drop", ref="434d2da28254acc8de4940c1dc3907ac72973135") # previous commit
```
...
```{r}
cat("This \"string\" contain quotation marks.")
```
...
## Advanced data structures (tidy data, rich data objects)

## Bioconductor classes (ExpressionSet, SingleCellExperiment)

## Plotting with ggplots2

### pheatmap (is this built on ggplots?

## Visualisation of scRNA-Seq data

### Plotting cells (PCA scatterplot overlayed with metadata)
