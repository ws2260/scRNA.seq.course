...
RUN Rscript -e "source('https://bioconductor.org/biocLite.R');biocLite('SingleCellExperiment')"
RUN Rscript -e "source('https://bioconductor.org/biocLite.R');biocLite('Rhdf5lib')"
RUN Rscript -e "source('https://bioconductor.org/biocLite.R');biocLite('beachmat')"
...
RUN Rscript -e "source('https://bioconductor.org/biocLite.R');biocLite('scfind')"
RUN Rscript -e "source('https://bioconductor.org/biocLite.R');biocLite('scmap')"
